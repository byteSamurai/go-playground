...
(function () {
    ...
    function playground(opts) {
        ...
        var presetUrl = "http://go-files.byte-samurai.de/";
        ...
        $("#presets").change(function () {
            ...
            $.get(presetUrl + fileName)
                .done(function (data) {
                    editor.setValue(data)
                });
            //hide/show prev/next
            var options = $("#presets").find("option");
            if (options.first().attr("value") === fileName) {
                $("#prev").hide()
            } else {
                $("#prev").show()
            }
            if (options.last().attr("value") === fileName) {
                $("#next").hide()
            } else {
                $("#next").show()
            }
        ...
        $("#next").click(function () {
            var presets = $("#presets");
            var selection = presets.find('option:selected');
            selection.next().attr("selected", true);
        ...
        $("#prev").click(function () {
            var presets = $("#presets");
            var selection = presets.find('option:selected');
            selection.prev().attr("selected", true);
            selection.attr("selected", false);
            presets.trigger("change")
        });
